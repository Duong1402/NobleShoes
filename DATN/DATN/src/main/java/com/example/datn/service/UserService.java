...
public class UserService {
    ...
    public UserService(KhachHangRepository khachHangRepo,
    ...
    public Optional<UserLookupResult> findByTaiKhoan(String taiKhoan) {
        ...
        // 1) NhanVien (Repository trả Optional -> không bọc Optional.ofNullable nữa)
        Optional<NhanVien> nvOpt = nhanVienRepo.findByTaiKhoan(taiKhoan);
        if (nvOpt.isPresent()) {
    ...
    public void updatePassword(String taiKhoan, String userType, String rawNewPassword) {
        ...
        if ("EMPLOYEE".equals(userType)) {
            NhanVien nv = nhanVienRepo.findByTaiKhoan(taiKhoan)
                    .orElseThrow(() -> new RuntimeException("Lỗi hệ thống: Không tìm thấy nhân viên."));
            ...
            throw new RuntimeException("userType không hợp lệ: " + userType);
        }
    }
}
